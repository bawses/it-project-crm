...
export default async function handler(req: Request, res: Response) {
  try {
    if (!TESTING) {
      ...
      // Only allow creation and get of your own manual contacts
      req.body.ownerId = sessionId;
    }
    var dbResponse = await indexHandler<IManualContact>(req.method as RequestType, DataType.ManualContact, req.body);
  } catch (err: any) {
